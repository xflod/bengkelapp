...
export default function PartnerSalesPage() {
  ...
  React.useEffect(() => {
    const fetchInitialData = async () => {
      ...
      if (productsError) {
        console.error("Error fetching partner products (raw):", JSON.stringify(productsError, null, 2));
